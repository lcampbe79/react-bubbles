...
- [x] Explain what a token is used for.
        *Tokens are used to verify that you have the authorization/credentials to have access to said page.

- [x] What steps can you take in your web apps to keep your data secure?
        *Steps tp keep data secure include using HTTPS, changing passwords often, make sure all software is up to date.

- [x] Describe how web servers work.
        *Web servers work by getting an IP address from the domain name. After that, the browser will request the full URL. The web server then responds to that request and then displays the page.

- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
        *HTTP methods that map to CRUD are PUT, POST, GET and DELETE.
